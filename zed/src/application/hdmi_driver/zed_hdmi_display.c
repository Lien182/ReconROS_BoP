...
int zed_hdmi_display_init( zed_hdmi_display_t *pDemo )
{
   ...
   printf("\n\r");
   printf("------------------------------------------------------\n\r");
   printf("--        ZedBoard HDMI Display Controller          --\n\r");
   printf("------------------------------------------------------\n\r");
   printf("\n\r");
  ...
  while (1)
  {
   ...
   printf( "HDMI Output Re-Initialization ...\n\r" );
   {
      uint8_t num_bytes;
      int i;
